# -*- coding: utf-8 -*-
"""
V7c - ResNet50 + Weights & Biases Integration
Basierend auf v6a (beste Version) mit ResNet50 Architektur

V7c Features:
1. ✅ ResNet50 Architecture (25M params)
...
Erwartung: ResNet50 sollte ähnlich oder besser als v6a (82.90% test acc) sein
"""
...
from models.resnet import resnet50, check_initialization
...
# v7c liegt in Imagenette/v7/v7c/, also 3 Ebenen tief
...
# See import at top: from models.resnet import resnet50, check_initialization
#
# ResNet50 specs:
...
def main():
    ...
    # Model - ResNet50
    model = resnet50(num_classes=cfg.num_classes, dropout=cfg.dropout,
