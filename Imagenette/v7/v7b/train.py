# -*- coding: utf-8 -*-
"""
V7b - ResNet34 + Weights & Biases Integration
Basierend auf v6a (beste Version) mit ResNet34 Architektur

V7b Features:
1. ✅ ResNet34 Architecture (21M params)
...
Erwartung: ResNet34 sollte ähnlich oder besser als v6a (82.90% test acc) sein
"""
...
from models.resnet import resnet34, check_initialization
...
# v7b liegt in Imagenette/v7/v7b/, also 3 Ebenen tief
...
# See import at top: from models.resnet import resnet34, check_initialization
#
# ResNet34 specs:
...
def main():
    ...
    # Model - ResNet34
    model = resnet34(num_classes=cfg.num_classes, dropout=cfg.dropout,
